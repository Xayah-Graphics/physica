...
export module physica.example.deformables.cloth.fast_projection;

import std;
import physica.deformables.cloth.model;
import physica.deformables.cloth.solvers.fast_projection;
import physica.example.deformables.cloth.support.scene;

export namespace physica::examples::cloth::fast_projection {
    struct Summary final {
        std::uint32_t frames;
        double physical_time;
        float maximum_absolute_edge_constraint_error;
    ...
    private:
        ...
        deformables::cloth::solvers::fast_projection::Solver solver;
    ...
    Summary Simulation::summarize() {
        ...
        return {
            ...
            .maximum_absolute_edge_constraint_error = maximum_absolute_edge_constraint_error,
...
} // namespace physica::examples::cloth::fast_projection
