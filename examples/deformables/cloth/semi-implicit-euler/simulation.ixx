...
export module physica.example.deformables.cloth.semi_implicit_euler;
...
export namespace physica::examples::cloth::semi_implicit_euler {
...
} // namespace physica::examples::cloth::semi_implicit_euler
