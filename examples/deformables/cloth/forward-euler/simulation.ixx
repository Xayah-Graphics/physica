...
export module physica.example.deformables.cloth.forward_euler;

import std;
import physica.deformables.cloth.constraints.fixed_position;
import physica.deformables.cloth.integrators.forward_euler;
...
export namespace physica::examples::cloth::forward_euler {
    ...
    private:
        ...
        deformables::cloth::solvers::explicit_dynamics::Solver<float, deformables::cloth::operators::MassSpringForce, deformables::cloth::integrators::ForwardEuler, deformables::cloth::constraints::FixedPositionConstraint> solver;
...
} // namespace physica::examples::cloth::forward_euler
