...
namespace physica::reconstruction::instant_ngp {
    ...
    Network<Shape>::Network(const ::cuda::stream_ref source_stream, const std::uint32_t seed)
        : stream{source_stream}, parameters_full_precision{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, parameters{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, gradients{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, first_moments{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, second_moments{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, parameter_steps{stream, ::cuda::device_default_memory_pool(stream.device()), parameter_count, ::cuda::no_init}, density_input{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(grid_output_width) * Shape.training_batch_size, ::cuda::no_init},
          field_features{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(color_input_width) * Shape.training_batch_size, ::cuda::no_init}, output{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.color.output_width) * Shape.inference_capacity, ::cuda::no_init}, color_output_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.color.output_width) * Shape.training_batch_size, ::cuda::no_init}, color_input_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(color_input_width) * Shape.training_batch_size, ::cuda::no_init}, density_input_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(grid_output_width) * Shape.training_batch_size, ::cuda::no_init},
          density_forward_hidden{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.density.hidden_layer_count) * Shape.density.width * Shape.training_batch_size, ::cuda::no_init}, color_forward_hidden{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.color.hidden_layer_count) * Shape.color.width * Shape.training_batch_size, ::cuda::no_init}, density_backward_hidden{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.density.hidden_layer_count) * Shape.density.width * Shape.training_batch_size, ::cuda::no_init}, color_backward_hidden{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(Shape.color.hidden_layer_count) * Shape.color.width * Shape.training_batch_size, ::cuda::no_init}, cublaslt_workspace{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(64u) * 1024u * 1024u, ::cuda::no_init} {
