...
namespace physica::reconstruction::instant_ngp {
    ...
    Rendering<Shape, NetworkSpec>::Rendering(const ::cuda::stream_ref source_stream) : stream{source_stream}, compacted_samples{stream, ::cuda::device_default_memory_pool(stream.device()), NetworkSpec.training_batch_size, ::cuda::no_init}, gradients{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(NetworkSpec.training_batch_size) * NetworkSpec.color.output_width, ::cuda::no_init}, requested_compacted_sample_counter{stream, ::cuda::device_default_memory_pool(stream.device()), 1uz, ::cuda::no_init}, used_compacted_sample_counter{stream, ::cuda::device_default_memory_pool(stream.device()), 1uz, ::cuda::no_init}, training_loss_sum{stream, ::cuda::device_default_memory_pool(stream.device()), 1uz, ::cuda::no_init}, evaluation_loss_sum{stream, ::cuda::device_default_memory_pool(stream.device()), 1uz, ::cuda::no_init} {}
