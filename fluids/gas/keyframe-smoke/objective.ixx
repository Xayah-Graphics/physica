...
export module physica.fluids.gas.keyframe_smoke.objective;

import std;
export import physica.fluids.gas.keyframe_smoke.solver;
...
export namespace physica::fluids::gas::keyframe_smoke {
    ...
    struct StepRecord final {
        std::uint32_t step{};
        DenseControl control;
        StepCache cache;
        StepObjectiveCache objective;
        StepMetrics metrics;
    };
