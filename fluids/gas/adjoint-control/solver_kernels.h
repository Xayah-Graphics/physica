#ifndef PHYSICA_FLUIDS_GAS_ADJOINT_CONTROL_SOLVER_KERNELS_H
#define PHYSICA_FLUIDS_GAS_ADJOINT_CONTROL_SOLVER_KERNELS_H
...
namespace physica::fluids::gas::adjoint_control::cuda_detail {
    ...
    void heat_jvp(::cuda::stream_ref stream, Grid grid, float buoyancy, ConstScalarView density_tangent, CenteredVectorView force_tangent);
    void heat_vjp(::cuda::stream_ref stream, Grid grid, float buoyancy, ConstCenteredVectorAdjointView force_adjoint, ScalarAdjointView density_adjoint);
