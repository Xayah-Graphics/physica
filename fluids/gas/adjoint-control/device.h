#ifndef PHYSICA_FLUIDS_GAS_ADJOINT_CONTROL_DEVICE_H
#define PHYSICA_FLUIDS_GAS_ADJOINT_CONTROL_DEVICE_H
...
namespace physica::fluids::gas::adjoint_control::cuda_detail {
    ...
    inline ScalarView::operator ConstScalarView() const { return {values}; }
    ...
    inline CenteredVectorView::operator ConstCenteredVectorView() const { return {x, y, z}; }
    ...
    inline StaggeredVectorView::operator ConstStaggeredVectorView() const { return {x, y, z}; }
    ...
    inline ScalarAdjointView::operator ConstScalarAdjointView() const { return {values}; }
    ...
    inline CenteredVectorAdjointView::operator ConstCenteredVectorAdjointView() const { return {x, y, z}; }
    ...
    inline StaggeredVectorAdjointView::operator ConstStaggeredVectorAdjointView() const { return {x, y, z}; }
} // namespace physica::fluids::gas::adjoint_control::cuda_detail
