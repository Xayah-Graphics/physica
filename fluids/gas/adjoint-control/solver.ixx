...
import std;
export import physica.fluids.gas.adjoint_control.domain;
...
export namespace physica::fluids::gas::adjoint_control {
    ...
    struct StepCache final {
        StaggeredVectorField controlled_velocity;
        StaggeredVectorField advected_velocity;
        ScalarField advected_density;
        ScalarField transported_density;
        StaggeredVectorField diffused_velocity;
        CenteredVectorField heat_force;
        StaggeredVectorField heated_velocity;
        StaggeredVectorField constrained_velocity;
    ...
    struct SolverConfiguration final {
        ...
        std::uint32_t pressure_iterations{100u};
        float viscosity{};
        float density_buoyancy{1.5F};
    ...
    private:
        ...
        struct AdjointWorkspace final {
            ScalarAdjointField transported_density;
            ...
            StaggeredVectorAdjointField constrained_velocity;
            StaggeredVectorAdjointField heated_velocity;
            CenteredVectorAdjointField heat_force;
            StaggeredVectorAdjointField diffused_velocity;
            StaggeredVectorAdjointField advected_velocity;
            StaggeredVectorAdjointField raw_advected_velocity;
            StaggeredVectorAdjointField controlled_velocity;
