...
namespace physica::reconstruction::pinfs {
    ...
    DenseNetwork::DenseNetwork(const ::cuda::stream_ref source_stream, NetworkConfiguration source_configuration, const std::uint32_t source_capacity, const std::uint32_t source_derivative_capacity, const std::uint32_t source_maximum_derivative_count, const std::uint32_t seed)
        : stream{source_stream}, configuration{std::move(source_configuration)}, maximum_width{std::ranges::max(configuration.layers | std::views::transform([](const LayerConfiguration& layer) { return std::max(layer.input_width, layer.output_width); }))}, adjoints_a{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_capacity, ::cuda::no_init}, adjoints_b{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_capacity, ::cuda::no_init}, derivative_adjoints_a{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_derivative_capacity * source_maximum_derivative_count, ::cuda::no_init}, derivative_adjoints_b{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_derivative_capacity * source_maximum_derivative_count, ::cuda::no_init},
          network_input_adjoints{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.input_width) * source_capacity, ::cuda::no_init}, network_input_derivative_adjoints{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.input_width) * source_derivative_capacity * source_maximum_derivative_count, ::cuda::no_init}, blended_inputs{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_capacity, ::cuda::no_init}, blended_input_derivatives{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_derivative_capacity * source_maximum_derivative_count, ::cuda::no_init}, blended_input_adjoints{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_capacity, ::cuda::no_init},
          blended_input_derivative_adjoints{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(maximum_width) * source_derivative_capacity * source_maximum_derivative_count, ::cuda::no_init} {
    ...
    DenseNetwork::Layer::Layer(const ::cuda::stream_ref stream, const LayerConfiguration source_configuration, const std::uint32_t capacity, const std::uint32_t derivative_capacity, const std::uint32_t maximum_derivative_count)
        : configuration{source_configuration}, weights{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.input_width) * configuration.output_width, ::cuda::no_init}, normalized_weights{stream, ::cuda::device_default_memory_pool(stream.device()), configuration.weight_normalization ? weights.size() : 0uz, ::cuda::no_init}, biases{stream, ::cuda::device_default_memory_pool(stream.device()), configuration.output_width, ::cuda::no_init}, scales{stream, ::cuda::device_default_memory_pool(stream.device()), configuration.weight_normalization ? configuration.output_width : 0uz, ::cuda::no_init}, weight_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), weights.size(), ::cuda::no_init}, bias_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), biases.size(), ::cuda::no_init}, scale_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), scales.size(), ::cuda::no_init},
          normalized_weight_gradients{stream, ::cuda::device_default_memory_pool(stream.device()), normalized_weights.size(), ::cuda::no_init}, weight_first_moments{stream, ::cuda::device_default_memory_pool(stream.device()), weights.size(), ::cuda::no_init}, bias_first_moments{stream, ::cuda::device_default_memory_pool(stream.device()), biases.size(), ::cuda::no_init}, scale_first_moments{stream, ::cuda::device_default_memory_pool(stream.device()), scales.size(), ::cuda::no_init}, weight_second_moments{stream, ::cuda::device_default_memory_pool(stream.device()), weights.size(), ::cuda::no_init}, bias_second_moments{stream, ::cuda::device_default_memory_pool(stream.device()), biases.size(), ::cuda::no_init}, scale_second_moments{stream, ::cuda::device_default_memory_pool(stream.device()), scales.size(), ::cuda::no_init},
          inputs{stream, ::cuda::device_default_memory_pool(stream.device()), configuration.append_network_input ? static_cast<std::size_t>(configuration.input_width) * capacity : 0uz, ::cuda::no_init}, input_derivatives{stream, ::cuda::device_default_memory_pool(stream.device()), configuration.append_network_input ? static_cast<std::size_t>(configuration.input_width) * derivative_capacity * maximum_derivative_count : 0uz, ::cuda::no_init}, linear{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.output_width) * capacity, ::cuda::no_init}, linear_derivatives{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.output_width) * derivative_capacity * maximum_derivative_count, ::cuda::no_init}, outputs{stream, ::cuda::device_default_memory_pool(stream.device()), linear.size(), ::cuda::no_init},
          output_derivatives{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(configuration.output_width) * derivative_capacity * maximum_derivative_count, ::cuda::no_init} {}
