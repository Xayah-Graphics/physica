...
namespace physica::reconstruction::pinfs {
    Sampling::Sampling(const ::cuda::stream_ref source_stream, const std::uint32_t source_maximum_ray_count, const std::uint32_t source_maximum_samples_per_ray, const std::uint32_t source_maximum_importance_samples)
        : stream{source_stream}, coarse_z{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init}, coarse_positions{stream, ::cuda::device_default_memory_pool(stream.device()), coarse_z.size(), ::cuda::no_init}, coarse_dynamic_points{stream, ::cuda::device_default_memory_pool(stream.device()), coarse_z.size(), ::cuda::no_init}, coarse_directions{stream, ::cuda::device_default_memory_pool(stream.device()), coarse_z.size(), ::cuda::no_init},
          fine_z{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init}, fine_positions{stream, ::cuda::device_default_memory_pool(stream.device()), fine_z.size(), ::cuda::no_init}, fine_dynamic_points{stream, ::cuda::device_default_memory_pool(stream.device()), fine_z.size(), ::cuda::no_init}, fine_directions{stream, ::cuda::device_default_memory_pool(stream.device()), fine_z.size(), ::cuda::no_init}, pdf_z{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_importance_samples, ::cuda::no_init}, upsample_z_a{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init},
          upsample_z_b{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init}, upsample_sdf_a{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init}, upsample_sdf_b{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_samples_per_ray, ::cuda::no_init}, new_z{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_importance_samples, ::cuda::no_init}, new_positions{stream, ::cuda::device_default_memory_pool(stream.device()), new_z.size(), ::cuda::no_init}, new_sdf{stream, ::cuda::device_default_memory_pool(stream.device()), static_cast<std::size_t>(source_maximum_ray_count) * source_maximum_importance_samples, ::cuda::no_init},
          current_upsample_z{upsample_z_a.data()}, next_upsample_z{upsample_z_b.data()}, current_upsample_sdf{upsample_sdf_a.data()}, next_upsample_sdf{upsample_sdf_b.data()} {}
