...
export namespace physica::fluids::gas {
    ...
    struct Domain final {
        ...
        grid::Grid grid;
        ScalarField<std::uint32_t> collider_ids;
        VectorField<float> collider_velocity;
        ...
        [[nodiscard]] ScalarField<float> allocate_collider_field(std::span<const float> values) const;
