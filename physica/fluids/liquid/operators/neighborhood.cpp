...
namespace physica::fluids::liquid::operators {
    Neighborhood UniformGridNeighborhood::allocate_cache(const meshfree::Model& model) const {
        ...
        return {
            .sorted_keys             = ::cuda::device_buffer<std::uint64_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), configuration.particle_count, ::cuda::no_init},
            .sorted_particle_indices = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), configuration.particle_count, ::cuda::no_init},
            .cell_offsets            = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), cell_count + 1uz, ::cuda::no_init},
            .sorted_boundary_keys    = ::cuda::device_buffer<std::uint64_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), configuration.boundary_particles.size(), ::cuda::no_init},
            .sorted_boundary_indices = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), configuration.boundary_particles.size(), ::cuda::no_init},
            .boundary_cell_offsets   = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), cell_count + 1uz, ::cuda::no_init},
    ...
    UniformGridNeighborhood::Workspace UniformGridNeighborhood::allocate_workspace(const meshfree::Model& model) const {
        return {
            .unsorted_keys             = ::cuda::device_buffer<std::uint64_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), model.configuration.particle_count, ::cuda::no_init},
            .unsorted_particle_indices = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), model.configuration.particle_count, ::cuda::no_init},
            .unsorted_boundary_keys    = ::cuda::device_buffer<std::uint64_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), model.configuration.boundary_particles.size(), ::cuda::no_init},
            .unsorted_boundary_indices = ::cuda::device_buffer<std::uint32_t>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), model.configuration.boundary_particles.size(), ::cuda::no_init},
            .sort_scratch              = ::cuda::device_buffer<std::byte>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), kernels::neighborhood::radix_sort_storage_size(model.configuration.particle_count), ::cuda::no_init},
            .boundary_sort_scratch     = ::cuda::device_buffer<std::byte>{model.stream, ::cuda::device_default_memory_pool(model.stream.device()), kernels::neighborhood::radix_sort_storage_size(static_cast<std::uint32_t>(model.configuration.boundary_particles.size())), ::cuda::no_init},
        };
    }

    void UniformGridNeighborhood::build(const meshfree::Model& model, const std::uint64_t step_index, const simulation::VectorField<float>& positions, Neighborhood& neighborhood, Workspace& workspace) const {
        const meshfree::Configuration& configuration = model.configuration;
