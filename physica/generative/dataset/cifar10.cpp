...
namespace physica::generative {
    Cifar10TrainingSet::Cifar10TrainingSet(const std::filesystem::path& directory) : images(static_cast<std::size_t>(image_count) * image_byte_count), labels(image_count) {
