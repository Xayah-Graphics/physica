#ifndef PHYSICA_FIELD_DEVICE_CUH
#define PHYSICA_FIELD_DEVICE_CUH
...
namespace physica::field {
    ...
    __device__ inline float affine_component(const Matrix3View<const float> affine, const std::uint32_t index, const int axis, const Vector3<float> displacement) {
