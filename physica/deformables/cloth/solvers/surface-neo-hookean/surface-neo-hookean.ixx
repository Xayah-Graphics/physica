...
export module physica.deformables.cloth.solvers.surface_neo_hookean;
...
export namespace physica::deformables::cloth::solvers::surface_neo_hookean {
    struct Solver final {
        ...
        struct StepCache final {
            ...
            simulation::ScalarField<float> surface_jacobians;
            simulation::ScalarField<float> log_surface_jacobians;
            ...
            simulation::ScalarField<float> triangle_domain_steps;
            simulation::ScalarField<float> maximum_domain_step;
    ...
    private:
        ...
        struct HostData final {
            ...
            std::vector<float> line_search_contractions;
        };
        ...
        simulation::ScalarField<float> line_search_contractions;
    };
