...
export module physica.deformables.cloth.solvers.stvk_fem;
...
export namespace physica::deformables::cloth::solvers::stvk_fem {
    struct Solver final {
        ...
        struct StepCache final {
            ...
            simulation::VectorField<float> green_strains;
